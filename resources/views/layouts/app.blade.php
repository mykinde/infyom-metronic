...
<head>
    ...
    <link href="{{ asset('metronic/simple-line-icons.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronic/bootstrap.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronic/uniform.default.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronic/bootstrap-switch.min.css') }}" rel="stylesheet" type="text/css"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL PLUGIN STYLES -->
    <link href="{{ asset('metronic/daterangepicker-bs3.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronic/fullcalendar.min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronicjqvmap.css') }}" rel="stylesheet" type="text/css"/>
    <!-- END PAGE LEVEL PLUGIN STYLES -->
    <!-- BEGIN PAGE STYLES -->
    <link href="{{ asset('metronic/tasks.css') }}" rel="stylesheet" type="text/css"/>
    <!-- END PAGE STYLES -->
    <!-- BEGIN THEME STYLES -->
    <link href="{{ asset('metronic/components.css') }}" id="style_components" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronic/plugins.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronic/layout.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('metronic/darkblue.css') }}" rel="stylesheet" type="text/css" id="style_color"/>
    <link href="{{ asset('metronic/custom.css') }}" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="{{ asset('metronic/logo.png') }}" alt="logo" class="logo-default"/>
            </a>
